...
#         {"user_id": chat.user_id, "chat_name": chat.chat_name}
#     )
#     if existing_chat:
...
#         {"user_id": message.user_id, "chat_id": message.chat_id}
#     )
#     if not chat:
...
#             {"user_id": messages.user_id, "chat_id": messages.chat_id}
#         )
#     )
#     if not messages:
...
#     return {
#         "messages": [
#             {**message, "_id": object_id_str(message["_id"])} for message in messages
#         ]
#     }
...
#     chat_result = chat_collection.delete_one(
...
#         {"user_id": chat.user_id, "message_id": chat.chat_id}
#     )
